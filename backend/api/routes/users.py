...
@router.get("/{user_id}", response_model=UserResponse, dependencies=[Depends(verify_admin_api_key)])
@limiter.limit(rate_limit_config.users)
...
@router.get("/email/{email}", response_model=list[UserResponse], dependencies=[Depends(verify_admin_api_key)])
@limiter.limit(rate_limit_config.users)
...
@router.get("/name/{name}", response_model=list[UserResponse], dependencies=[Depends(verify_admin_api_key)])
@limiter.limit(rate_limit_config.users)
