...
# Terminal 1: uv run python main.py -b
# Terminal 2: uv run python main.py -f
...
### Motion Variant Structure
Motion variants should always use the Variants type from the frame motion library
...
17. **Animations**  should use the frame motion library rather than raw css if possible
