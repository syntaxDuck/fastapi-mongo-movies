...
class CommentQuery(BaseModel):
    ...
    movie_id: Optional[str] = Query(
        None, alias="movie_id", description="Filter by movie ID"
    )
...
class MovieQuery(BaseModel):
    ...
    num_mflix_comments: Optional[int] = Query(
    ...
    released: Optional[datetime] = Query(
